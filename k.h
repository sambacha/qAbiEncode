...
extern K ee (K), ktj (I, J), ka (I), kb (I), kg (I), kh (I), ki (I), kj (J),
  ke (F), kf (F), kc (I), ks (S), kd (I), kz (F), kt (I), sd1 (I, K (*) (I)),
  dl (V *f, J), knk (I, ...), kp (S), ja (K *, V *), js (K *, S), jk (K *, K),
  jv (K *k, K), k (I, const S, ...), xT (K), xD (K, K), ktd (K), r1 (K),
  krr (const S), orr (const S), dot (K, K), b9 (I, K), d9 (K), sslInfo (K x),
  vaknk (I, va_list), vak (I, const S, va_list);
#ifdef __cplusplus
}
#endif
